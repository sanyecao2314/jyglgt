...
/**
 * 读取物流自动化系统的收货过磅单数据后台预警
 * ·@author 施鹏
 * */
public class PoStorBusinessPlugin implements IBusinessPlugin {
	...
	public String implementReturnMessage(Key[] arg0, String arg1, UFDate arg2)
		...
		Logger.debug("fd log:读取物流自动化系统的收货过磅单预警....Begin");
		Logger.debug("in the method implementReturnFromatMsg(keys[],corpPK,clientLoginDate)");		
//		Proxy.getItf().insertIntePoStorByBfgl(IDatasourceConst.BFJL);
		new PoStoreDAO().insertIntePoStorByBfgl(IDatasourceConst.BFJL);
