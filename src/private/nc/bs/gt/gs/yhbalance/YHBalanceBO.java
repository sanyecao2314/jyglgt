 ...
 * @version v1.0
 * */
public class YHBalanceBO extends ServerDAO{
	...
	public void writebacktoBalance(ExAggSellPaymentJSVO aggvo,String pk_corp) throws BusinessException {
		YHBalanceBOByJsPrice boprice=new YHBalanceBOByJsPrice();
		try {
			boprice.writebacktoBalance(aggvo, pk_corp);
	...
	public void deletebacktoBalance(ExAggSellPaymentJSVO aggvo,String pk_corp) throws BusinessException {
		...
		try {
			...
			yhbo.deletebacktoBalance3(aggvo, pk_corp);
		} catch (Exception e) {
			e.printStackTrace();
