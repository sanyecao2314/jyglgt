 ...
 */
public class YhBanlanceBackReceiveDMO extends ServerDAO {
	...
	public void backFhMny(
		    ...
		    UFDouble bprice=Toolkits.getUFDouble(jlbvo.getPreferentialmny().div(jlbvo.getSuttle()));      //优惠单价
...
//			    	}
	...
	private ArrayList<HashMap<String,String>> getMnyList(String pk_cumandoc,String pk_corp) throws BusinessException{
		...
		//客户全集团共享信用
		strSk.append(" select vbillcode,pk_credit,(nvl(skmny,0) - nvl(fhmny,0))kfhmny,cdprice,montax,voiceedate,voicesdate,txdays,priceway,pk_receiveway from gt_credit where (nvl(skmny,0) - nvl(fhmny,0))=0 and fhmny>0 ")
